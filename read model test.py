...
def main():
    ...
    agent = torch.load(dir, map_location=device)
    ...
    for episode in range(1, 300):
        ...
        while True:
            ...
            if done:
                ...
                b, _ = getBest.main(n, graph, list(_priorityList), levelList, edgesH, edgesQ, costList, p)
                ...
                average_b = all_b_reward / episode
                ...
                if episode > 50:
                    ...
                    best_r.append(average_b)
                break

    import matplotlib.pyplot as plt
    print("average_l", average_l, "average_c", average_c, "average_b", average_b, "PPO", -average_reward, "random",
          -r_average_reward)
    ...
    plt.plot(best_r, color='black', label='best')
    plt.legend()
